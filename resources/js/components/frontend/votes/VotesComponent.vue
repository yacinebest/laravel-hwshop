<template>
    <div class="pb-3">
        <svg @click="vote('UP')" class="thumbs-up" :class="{'thumbs-up-active':isUpvoted}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 478.2 478.2" style="enable-background:new 0 0 478.2 478.2;" xml:space="preserve">
            <g>
        ...
        {{ upvotes_count }}
        <svg @click="vote('DOWN')" class="thumbs-down" :class="{'thumbs-down-active':isDownvoted}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="475.092px" height="475.092px" viewBox="0 0 475.092 475.092" style="enable-background:new 0 0 475.092 475.092;" xml:space="preserve">
            <g>
        ...
        vote(type){
            if(this.authuser!=''){
                if ( this.isOwner ) {
                    ...
                    form.append('model',this.entity_model)

                    axios.post(`/votes/${this.entity_id}`,form)
                        .then( ({data})=>{
