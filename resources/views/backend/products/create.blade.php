@extends('backend.layouts.default.create',['page'=>'Product','route_name'=>'product'])
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"name"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"description"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"price"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"copy_number"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"started_at"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"datasheet"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"brands"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"parent_id"])
</div>
