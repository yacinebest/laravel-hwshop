@extends('backend.layouts.default.create',['page'=>'Payment','route_name'=>'payment'])
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"method"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"contact_info"])
</div>
...
<div class="form-group">
    ...
    @include('backend.layouts.form.error_field',['key'=>"phone_number"])
</div>
